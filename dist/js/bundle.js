...
var makeHnListItem = function makeHnListItem(item) {
  return '\n    <article class="List__item Item">\n      <h1 class="Item__title">\n        <a href="' + item.url + '" target="_blank">' + item.title + '</a>\n      </h1>\n      <ul class="Item__infos Infos">\n        <li class="Infos__item">' + item.points + ' points</li>\n        <li class="Infos__item">by ' + item.author + '</li>\n        <li class="Infos__item">' + item.num_comments + ' comments</li>\n        <li class="Infos__item">' + (0, _moment2.default)(item.created_at, 'YYYYMMDD').fromNow() + '</li>\n      </ul>\n    </article>\n  ';
};

var makeHnList = function () {
  var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(list, url) {
    var response, json;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(url).catch(function (ex) {
  ...
  return function makeHnList(_x, _x2) {
    return ref.apply(this, arguments);
  };
}();

var list = _util2.default.el('list');
var REQ_URL = 'https://hn.algolia.com/api/v1/search_by_date?tags=story&hitsPerPage=50';

makeHnList(list, REQ_URL);

},{"./util":301,"babel-polyfill":1,"moment":297,"whatwg-fetch":299}],301:[function(require,module,exports){
"use strict";
